    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if page.get_by_role("link", name="Log in", exact=True).is_visible():
                ...
                if page.get_by_text(text="English United States (en-US)").count() > 0:
                    page.get_by_text(text="English United States (en-US)").click()
                    page.get_by
                    print("English United States (en-US) selected")
                elif page.get_by_text(text="English United Kingdom (en-DE)").count() > 0:
                    page.get_by_text(text="English United Kingdom (en-DE)").click()
                    print("English United Kingdom (en-DE) selected")
                # context.request.get("https://sellercentral.amazon.com/home?mons_sel_locale=en_US&languageSwitched=1")
